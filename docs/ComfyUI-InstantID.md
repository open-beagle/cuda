...
### 安装插件 | comfyui-liveportrait

```bash
git clone https://github.com/shadowcz007/comfyui-liveportrait.git /beagle/ComfyUI/custom_nodes/comfyui-liveportrait && \
pip install -r /beagle/ComfyUI/custom_nodes/comfyui-liveportrait/requirements.txt
```
